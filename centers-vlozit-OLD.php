...
if($_POST['action']=="vlozit"):
	...
	if($idcko):	//--pokud vse vlozeno, vim id vlozeneho radku
		...
		$vysledek_if = mysql_query("SELECT ID AS ID_polozky FROM setting_preliminary");
			if(mysql_num_rows($vysledek_if)):
				while($zaz_if = mysql_fetch_array($vysledek_if)):
					...
					'".mysql_real_escape_string($_POST['visible_'.$ID_polozky])."',
					'".mysql_real_escape_string($_POST['required_'.$ID_polozky])."',
					'".mysql_real_escape_string($_POST['label_'.$ID_polozky])."'
					)");
		...
		$vysledek_if = mysql_query("SELECT ID AS ID_polozky FROM setting_sample");
			if(mysql_num_rows($vysledek_if)):
				while($zaz_if = mysql_fetch_array($vysledek_if)):
					...
					('$ID_polozky',
					'".mysql_real_escape_string($idcko)."',
					'".mysql_real_escape_string($_POST['samp_visible_'.$ID_polozky])."',
					'".mysql_real_escape_string($_POST['samp_required_'.$ID_polozky])."',
					'".mysql_real_escape_string($_POST['samp_label_'.$ID_polozky])."'
					)");
		...
		mls_edta, mls_heparin, mls_acd, mls_clotted, mls_dna, mls_cpa, tubes_edta, tubes_heparin, tubes_acd, tubes_clotted, tubes_dna, tubes_cpa) VALUES
			('$idcko',
			'".mysql_real_escape_string($_POST['sample_to_institution'])."',
			'".mysql_real_escape_string($_POST['invoice_to_institution'])."',
			'".mysql_real_escape_string($_POST['sample_address'])."',
			'".mysql_real_escape_string($_POST['invoice_address'])."',
			'".mysql_real_escape_string($_POST['sample_attention'])."',
			'".mysql_real_escape_string($_POST['invoice_attention'])."',
			'".mysql_real_escape_string($_POST['sample_phone'])."',
			'".mysql_real_escape_string($_POST['invoice_phone'])."',
			'".mysql_real_escape_string($_POST['sample_fax'])."',
			'".mysql_real_escape_string($_POST['invoice_fax'])."',
			'".mysql_real_escape_string($_POST['sample_email'])."',
			'".mysql_real_escape_string($_POST['invoice_email'])."',
			'".mysql_real_escape_string($_POST['monday'])."',
			'".mysql_real_escape_string($_POST['tuesday'])."',
			'".mysql_real_escape_string($_POST['wednesday'])."',
			'".mysql_real_escape_string($_POST['thursday'])."',
			'".mysql_real_escape_string($_POST['friday'])."',
			'".mysql_real_escape_string($_POST['saturday'])."',
			'".mysql_real_escape_string($_POST['sunday'])."',
			'".mysql_real_escape_string($_POST['mls_edta'])."',
			'".mysql_real_escape_string($_POST['mls_heparin'])."',
			'".mysql_real_escape_string($_POST['mls_acd'])."',
			'".mysql_real_escape_string($_POST['mls_clotted'])."',
			'".mysql_real_escape_string($_POST['mls_dna'])."',
			'".mysql_real_escape_string($_POST['mls_cpa'])."',
			'".mysql_real_escape_string($_POST['tubes_edta'])."',
			'".mysql_real_escape_string($_POST['tubes_heparin'])."',
			'".mysql_real_escape_string($_POST['tubes_acd'])."',
			'".mysql_real_escape_string($_POST['tubes_clotted'])."',
			'".mysql_real_escape_string($_POST['tubes_dna'])."',
			'".mysql_real_escape_string($_POST['tubes_cpa'])."'
			)");
			...
			if(mysql_num_rows($vysledek_if)):
				while($zaz_if = mysql_fetch_array($vysledek_if)):
					...
					if($_POST[$input_name]):
						...
						('$ID_polozky',
						'".$idcko."',
						'".mysql_real_escape_string($_POST[$input_name])."'
						)");
					endif;
...
if($_POST['action']=="upravit"):
	...
	*/
	...
	if($SQL):	//--pokud update neco zmenil
		...
		mysql_query("DELETE FROM setting_preliminary_custom WHERE ID_center='".mysql_real_escape_string($_GET['ID'])."'");
		...
		mysql_query("DELETE FROM setting_sample_custom WHERE ID_center='".mysql_real_escape_string($_GET['ID'])."'");
		...
		mls_edta, mls_heparin, mls_acd, mls_clotted, mls_dna, mls_cpa, tubes_edta, tubes_heparin, tubes_acd, tubes_clotted, tubes_dna, tubes_cpa) VALUES
			...
			sample_to_institution='".mysql_real_escape_string($_POST['sample_to_institution'])."',
			invoice_to_institution='".mysql_real_escape_string($_POST['invoice_to_institution'])."',
			sample_address='".mysql_real_escape_string($_POST['sample_address'])."',
			invoice_address='".mysql_real_escape_string($_POST['invoice_address'])."',
			sample_attention='".mysql_real_escape_string($_POST['sample_attention'])."',
			invoice_attention='".mysql_real_escape_string($_POST['invoice_attention'])."',
			sample_phone='".mysql_real_escape_string($_POST['sample_phone'])."',
			invoice_phone='".mysql_real_escape_string($_POST['invoice_phone'])."',
			sample_fax='".mysql_real_escape_string($_POST['sample_fax'])."',
			invoice_fax='".mysql_real_escape_string($_POST['invoice_fax'])."',
			sample_email='".mysql_real_escape_string($_POST['sample_email'])."',
			invoice_email='".mysql_real_escape_string($_POST['invoice_email'])."',
			...
			mls_edta='".mysql_real_escape_string($_POST['mls_edta'])."',
			mls_heparin='".mysql_real_escape_string($_POST['mls_heparin'])."',
			mls_acd='".mysql_real_escape_string($_POST['mls_acd'])."',
			mls_clotted='".mysql_real_escape_string($_POST['mls_clotted'])."',
			mls_dna='".mysql_real_escape_string($_POST['mls_dna'])."',
			mls_cpa='".mysql_real_escape_string($_POST['mls_cpa'])."',
			tubes_edta='".mysql_real_escape_string($_POST['tubes_edta'])."',
			tubes_heparin='".mysql_real_escape_string($_POST['tubes_heparin'])."',
			tubes_acd='".mysql_real_escape_string($_POST['tubes_acd'])."',
			tubes_clotted='".mysql_real_escape_string($_POST['tubes_clotted'])."',
			tubes_dna='".mysql_real_escape_string($_POST['tubes_dna'])."',
			tubes_cpa='".mysql_real_escape_string($_POST['tubes_cpa'])."'
			");
		
		
		//volitelne labely reason2
		mysql_query("DELETE FROM setting_reasons2_custom WHERE ID_center='".mysql_real_escape_string($_GET['ID'])."'");
...
if(!$_POST['action']):
	...
	$vysledek = mysql_query("SELECT * FROM transplant_centers WHERE ID='".mysql_real_escape_string($_GET['ID'])."' LIMIT 1");
		...
		*/
		...
		if($_GET['ID']):
			...
			<h2 style=\"border-bottom:1px solid #969696; margin-bottom:10px;\">Preliminary request form setting</h2>";
				...
				$_hodnoty=array();
				$ma_udaje=0;
				$vysledek_if = mysql_query("SELECT ID_item, visible, required, label FROM setting_preliminary_custom WHERE ID_center='".mysql_real_escape_string($_GET['ID'])."'");
					if(mysql_num_rows($vysledek_if)):
						$ma_udaje=1;
						while($zaz_if = mysql_fetch_array($vysledek_if)):
							$zaz_if=htmlspecialchars_array_encode($zaz_if);
			...
			<h2 style=\"border-bottom:1px solid #969696; margin-bottom:10px;\">Sample request form setting</h2>";
				...
				$_hodnoty=array();
				$ma_udaje=0;
				$vysledek_if = mysql_query("SELECT ID_item, visible, required, label FROM setting_sample_custom WHERE ID_center='".mysql_real_escape_string($_GET['ID'])."'");
					if(mysql_num_rows($vysledek_if)):
						$ma_udaje=1;
						while($zaz_if = mysql_fetch_array($vysledek_if)):
							$zaz_if=htmlspecialchars_array_encode($zaz_if);
				...
				FROM setting_sample_default WHERE ID_center='".mysql_real_escape_string($_GET['ID'])."' LIMIT 1");
					if(mysql_num_rows($vysledek_if)):
			...
			<h2 style=\"border-bottom:1px solid #969696; margin-bottom:10px;\">Search request - Reason2 setting</h2>";
				...
				//nacteni custom hodnot
				$_hodnoty=array();
				$vysledek_if = mysql_query("SELECT ID_item, label FROM setting_reasons2_custom WHERE ID_center='".mysql_real_escape_string($_GET['ID'])."'");
					if(mysql_num_rows($vysledek_if)):
						while($zaz_if = mysql_fetch_array($vysledek_if)):
							$zaz_if=htmlspecialchars_array_encode($zaz_if);
							extract($zaz_if);
