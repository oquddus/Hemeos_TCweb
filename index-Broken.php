...
<div class="logo"><img src="img/hemeos/logo.png" width="300" height="165" alt=""></div>
...
<div class="patka"><div class="patka-svetlo">
	<div class="patka-vnitrek text4">
		<div class="patka-text1"><span class="text3 bold">Hemeos</span><br><br>Tel.: +1(855)943-6704<br>email: <a href="mailto:registration@hemeos.com" class="odkaz1">registration@hemeos.com</a></div>
	...
	<!--<div class="patka-text3">Copyright © 2010 Steiner,s.r.o.<br><br><? echo gtext('Verze',109)." ".$_version; ?><br>www.steiner.cz</div>-->
		<div class="patka-text3"><br><br>Beta Version 1.0<br>www.hemeos.com</div>
	</div>
</div></div>
