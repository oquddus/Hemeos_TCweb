...
function razeni($primarne){
	...
	if(htmlspecialchars($_GET['col'])):
		$orderby="";//mysql_real_escape_string(htmlspecialchars($_GET['col'])." ".htmlspecialchars($_GET['ord_'.str_replace(".","",htmlspecialchars($_GET['col']))]));
	else:
		$orderby="";//mysql_real_escape_string($primarne);
	endif;
}
...
function insert_tb($tabulka){
	...
	if(mysql_num_rows($vysledek)>0):
		...
		$dotaz_1="INSERT INTO ".mysql_real_escape_string($tabulka)." VALUES (";
		$dotaz_3=")";
