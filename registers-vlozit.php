	...
	echo "<form onsubmit=\"return Kontrola"; if($_GET['ID']): echo "2"; endif; echo "();\" enctype=\"multipart/form-data\" method=\"POST\" action=\"\" name=\"formular\">
		...
		<div class=\"form-lr\">
			...
			<div class=\"form-right\"><select style=\"width:150px;\" name=\"date_format\" id=\"date_format\">
				<option value=\"YYYY-MM-DD\""; if($date_format=="YYYY-MM-DD"): echo " selected"; endif; echo ">YYYY-MM-DD</option>
				<option value=\"M-D-YYYY\""; if($date_format=="M-D-YYYY"): echo " selected"; endif; echo ">M-D-YYYY</option>
				<option value=\"D-M-YYYY\""; if($date_format=="D-M-YYYY"): echo " selected"; endif; echo ">D-M-YYYY</option>
				<option value=\"M.D.YYYY\""; if($date_format=="M.D.YYYY"): echo " selected"; endif; echo ">M.D.YYYY</option>
				<option value=\"D.M.YYYY\""; if($date_format=="D.M.YYYY"): echo " selected"; endif; echo ">D.M.YYYY</option>
			</select></div>
		</div>
		...
		<div class=\"form-lr\">
			<div class=\"form-left\">Password: "; if(!$_GET['ID']): echo "<span class=\"povinne\">*</span>"; endif; echo "</div>
			<div class=\"form-right\"><input type=\"password\" style=\"width:".$width6."px;\" name=\"heslo\" value=\"\" autocomplete=\"off\"></div>
		</div>
		
		<div class=\"form-lr\">
			<div class=\"form-left\">Password again: "; if(!$_GET['ID']): echo "<span class=\"povinne\">*</span>"; endif; echo "</div>
