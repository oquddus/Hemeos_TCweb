...
//-----vypis dat
$vysledek = mysql_query("SELECT search_request.ID, RegID, ID_stavu, date_request, last_name, first_name, InstID, duvod_zamitnuti, search_request.PatientNum, search_request_stavy.stav, search_request_stavy.upresneni 
FROM search_request LEFT JOIN search_request_stavy ON(search_request.ID_stavu=search_request_stavy.ID) WHERE $where $where_hledej ORDER BY $orderby LIMIT $_od, $_na_stranku");
